    ...
    <main className="max-w-4xl mx-auto py-16 px-4 space-y-12">
      ...
      <section className="text-center space-y-4">
        <h1 className="text-4xl sm:text-5xl font-bold text-white">
          About <span className="text-violet-500">RepoVision</span>
        </h1>
      ...
      {/* What is RepoVision */}
      <Card>
        <h2 className="text-2xl font-semibold text-white mb-3">What is RepoVision?</h2>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {features.map((f) => (
            <Card key={f.title}>
              ...
              <h3 className="text-lg font-semibold text-white mt-2">{f.title}</h3>
      ...
      {/* Repository Analysis */}
      <Card>
        <h2 className="text-2xl font-semibold text-white mb-3">Repository Analysis</h2>
        <p className="text-gray-400 leading-relaxed">
      ...
      <Card>
        <h2 className="text-2xl font-semibold text-white mb-3">Repository Comparison</h2>
        <p className="text-gray-400 leading-relaxed">
      ...
      <div className="text-center pt-4">
        <Link
          to="/analyze"
          className="inline-block px-6 py-3 rounded-lg bg-violet-600 text-white font-medium hover:bg-violet-500 transition-colors"
        >
          Try It Now →
        </Link>
      </div>
